...
rg 'Preloaded and force-loaded|Tier 5 .*: total|  detail:|Tier 5 benchmark completed|Invalid block entity|DUMMY block entity|POI data mismatch|Failed to create block entity' "$log_file" > "$summary_file" || true
